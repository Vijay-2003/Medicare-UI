      ...
      <div className='container'>
        <div className='flex flex-col lg:flex-row gap-[90px] items-center justify-between'>
                ...
                <div>
                  <div className='lg:w-[570px]'>
                    ...
                    <p className='text_para'>
                      Lorem ipsum, dolor sit amet consectetur adipisicing elit. Temporibus, accusantium. Voluptate atque consectetur laborum nihil molestiae vitae omnis facilis quia minus excepturi. Voluptatibus a iure voluptates dicta quas? Iste, excepturi!
                    </p>
                ...
                <div className='flex gap-[30px] justify-end'>
                  <div>
                    <img className='w-full' src={heroImg01} alt='Not Found' />
                  </div>
                  <div className='mt-[30px]'>
                    <img src={heroImg02} alt='Not Found' className='w-full mb-[30px]' />
                    <img src={heroImg03} alt='Not Found' className='w-full' />
                  </div>
                </div>
        </div>
      </div>
         ...
         */}
         ...
         <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 lg:gap-[30px] mt-[30px] lg:mt-[55px]'>
          ...
          <div className='py-[30px] px-5'>
              ...
              Lorem ipsum, dolor sit amet consectetur adipisicing elit. Vitae, est alias! Magnam dolore voluptate est cupiditate, deleniti perspiciatis aut assumenda quidem animi, perferendis sunt voluptatibus placeat earum eum ullam quisquam!
                </p>
      ...
      <div className='container'>
          ...
          <ul className='pl-4'>
            <li className='text_para'>
              1. Schedulr the appointment directly.
            </li>
            <li className='text_para'>
          ...
          <div className='relative z-10 xl:w-[770px] flex justify-end mt-[50px] lg:mt-0'>
            <img src={featureImg} alt='Not Found' className='w-3/4' />
