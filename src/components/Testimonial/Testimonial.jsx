...
const Testimonial = () => {
  return (
    <div className='mt-[30px] lg:mt-[55px]'>
            <Swiper spaceBetween={30} slidesPerView={1} pagination={{clickable:true}}  // 1. modules={[Pagination]}
            breakpoints={{
                640: {
                    slidesPerView:1,
                    spaceBetween:0,
                ...
                <SwiperSlide>
                    <div className='py-[30px] px-5 rounded-[13px]'>
                        <div className='flex items-center gap-[3px]'>
                            <img src={patientAvatar} alt='Not Found' />
                            <div>
                                <h4 className='text-[18px] leading-[30px] font-semibold text-headingColor'>Ajay Kusekar
                                </h4>
