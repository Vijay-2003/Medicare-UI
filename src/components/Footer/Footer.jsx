...
const socialLinks = [
  {
    path:"https://www.facebook.com/profile.php?id=100069505254213",
    icon:<AiFillFacebook className='group:hover:text-white w-4 h-5' />,
  },
  {
    path:"https://github.com/Vijay-2003",
    icon:<AiFillGithub className='group:hover:text-white w-4 h-5' />,
  },
  {
    path:"https://instagram.com/vijay_kusekar?igshid=MzNINGNkZWQ4Mg==",
    icon:<AiOutlineInstagram className='group:hover:text-white w-4 h-5' />,
  },
  {
    path:"https://www.linkedin.com/in/vijay-digambar-kusekar-682235259",
        ...
        <div className='flex justify-between flex-col md:flex-row flex-wrap gap-[30px]'>
          <div>
            ...
            <p className='text-[16px] leading-7 font-[400] text-textColor'>
              Copyright &#169; {year} developed by Vijay Kusekar all rigths reserved.
            </p>
